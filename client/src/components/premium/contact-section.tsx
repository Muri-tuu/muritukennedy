  ...
  return (
    <section id="contact" className="py-24 px-6 lg:px-12">
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          <a
            href="https://wa.me/254115594826?text=Hello%20Kennedy%2C%20I'm%20interested%20in%20discussing%20a%20potential%20project%20opportunity."
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 hover:text-primary transition-colors font-mono text-sm"
          >
